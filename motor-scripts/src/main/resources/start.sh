...
nohup java $JAVA_OPTS $JMX_OPTS $JPDA_OPTS $LOGGING_CONFIG -Dlauncher.home=$LAUNCHER_HOME -classpath $CLASSPATH com.dinstone.motor.launcher.Launcher start > $LAUNCHER_OUT 2>&1 &