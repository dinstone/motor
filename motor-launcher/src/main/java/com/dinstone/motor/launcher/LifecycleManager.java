...
public class LifecycleManager {
    ...
    private boolean awaitEnabled = false;
    ...
    public LifecycleManager(Configuration config) {
        ...
        String enabled = config.getProperty("launcher.listen.enabled");
        if (enabled != null) {
            this.awaitEnabled = Boolean.parseBoolean(enabled);
        }

        if (awaitEnabled) {
            String portPro = config.getProperty("launcher.listen.port");
            try {
            ...
            String command = config.getProperty("launcher.listen.command");
            if (command != null) {
